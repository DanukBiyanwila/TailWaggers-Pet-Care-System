				...
				<div class="col">
					...
					<div class="test_slider_container">
						<div class="owl-carousel owl-theme test_slider">
							...
							<div class="owl-item">
								<div class="test_item">
									<div class="test_image"><img src="img/weli.jpg"></div>
									
									<div class="test_content_container">
										<div class="test_content">
											
											<div class="test_quote_title">SONAL DILMITH</div>
											<p class="test_quote_text">"I believe this website would be a very interesting one for all pet lovers. Anyone can get important details about all types of pets through this website"</p>
										</div>
									</div>
								</div>
							</div>
